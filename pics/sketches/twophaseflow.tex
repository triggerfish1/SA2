...
\begingroup
  ...
  \begin{picture}(1,0.77892919)%
    \put(0,0){\includegraphics[width=\unitlength]{pics/sketches/twophaseflow.pdf}}%
    ...
    \put(0.09013231,0.21524025){\color[rgb]{0,0,0}\makebox(0,0)[lb]{\smash{\Large$\Omega^+$}}}%
    \put(0.57083642,0.39713792){\color[rgb]{0,0,0}\makebox(0,0)[lb]{\smash{\Large$\Omega^-$}}}%
  \end{picture}%
\endgroup
